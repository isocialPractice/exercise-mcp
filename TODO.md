...
- [x] Use [markedPages](https://github.com/jhauga/markedPages)
  - [x] Improve from here
    - Asked for: a language tab select rendered from the marked page index
...
- [x] Complete reading
- [x] Make minor variation of weather example from
 ...
 and plug into:
  ...
  - [x] TypeScript: [vscode-emailClient](https://github.com/isocialPractice/vscode-emailClient)
    - [x] Add local `task.bat` script
  ...
  - [x] C#: [ccal](https://github.com/jhauga/ccal/tree/local-weather)
    - [x] Add local `task.bat` script
  - [x] Ruby: [street-crime](https://github.com/isocialPractice/street-crime)
    - [x] Add local `task.bat` script
